    ...
    return (
      <div className="card" style={{ margin: "10px" }}>
        <div className="card-body">
          ...
          <p className="card-text">Welcome to RideUp, your go-to app for safe, reliable and convenient transportation. We are a team of passionate individuals who are dedicated to making your travel experience as seamless as possible.<br/><br/>
